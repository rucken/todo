...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">rucken:todo-demo</a>
                </li>
                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-cac0578eb35d68e8385ac219616fbe4f"' : 'data-target="#xs-components-links-module-AppModule-cac0578eb35d68e8385ac219616fbe4f"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-cac0578eb35d68e8385ac219616fbe4f"' :
                                            'id="xs-components-links-module-AppModule-cac0578eb35d68e8385ac219616fbe4f"' }>
                                            <li class="link">
                                                <a href="components/AppComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AppComponent</a>
                                            </li>
                            ...
                            <li class="link">
                                <a href="modules/ProjectsFrameModule.html" data-type="entity-link">ProjectsFrameModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ProjectsFrameModule-2d07a1bf115e9bc4c07c4810afe5d434"' : 'data-target="#xs-components-links-module-ProjectsFrameModule-2d07a1bf115e9bc4c07c4810afe5d434"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ProjectsFrameModule-2d07a1bf115e9bc4c07c4810afe5d434"' :
                                            'id="xs-components-links-module-ProjectsFrameModule-2d07a1bf115e9bc4c07c4810afe5d434"' }>
                                            <li class="link">
                                                <a href="components/ProjectsFrameComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ProjectsFrameComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                            <li class="link">
                                <a href="modules/ProjectsPageModule.html" data-type="entity-link">ProjectsPageModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ProjectsPageModule-1e91f701ac83dbd7c8cdafebbd022d99"' : 'data-target="#xs-components-links-module-ProjectsPageModule-1e91f701ac83dbd7c8cdafebbd022d99"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ProjectsPageModule-1e91f701ac83dbd7c8cdafebbd022d99"' :
                                            'id="xs-components-links-module-ProjectsPageModule-1e91f701ac83dbd7c8cdafebbd022d99"' }>
                                            <li class="link">
                                                <a href="components/ProjectsPageComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ProjectsPageComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                            ...
                            <li class="link">
                                <a href="modules/StatusesFrameModule.html" data-type="entity-link">StatusesFrameModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-StatusesFrameModule-2f363366e67f2b81cd5e0effb19ab34b"' : 'data-target="#xs-components-links-module-StatusesFrameModule-2f363366e67f2b81cd5e0effb19ab34b"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-StatusesFrameModule-2f363366e67f2b81cd5e0effb19ab34b"' :
                                            'id="xs-components-links-module-StatusesFrameModule-2f363366e67f2b81cd5e0effb19ab34b"' }>
                                            <li class="link">
                                                <a href="components/StatusesFrameComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">StatusesFrameComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                            <li class="link">
                                <a href="modules/TasksFrameModule.html" data-type="entity-link">TasksFrameModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-TasksFrameModule-9752219555d012c92b9e124c9a066b9b"' : 'data-target="#xs-components-links-module-TasksFrameModule-9752219555d012c92b9e124c9a066b9b"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-TasksFrameModule-9752219555d012c92b9e124c9a066b9b"' :
                                            'id="xs-components-links-module-TasksFrameModule-9752219555d012c92b9e124c9a066b9b"' }>
                                            <li class="link">
                                                <a href="components/TasksFrameComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">TasksFrameComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
